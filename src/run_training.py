...
def run_training(args):
    ...
    text_denoiser = TextDenoiser(dataloader, vocab, betas=(args.beta1, args.beta2), lr=args.lr, n_T=args.n_T, embed_dim=args.embed_dim, d_model=args.d_model, nhead=args.nhead, num_layers=args.num_layers, dim_feedforward=args.dim_feedforward, use_old_arch=args.use_old_arch)
    text_denoiser.train()
